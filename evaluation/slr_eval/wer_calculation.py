...
def evaluate(prefix="./", mode="dev", evaluate_dir=None, evaluate_prefix=None,
    ...
    os.system(f"bash ./evaluation/slr_eval/preprocess.sh {prefix + output_file} {prefix}tmp.ctm {prefix}tmp2.ctm")
    ...
    os.system(f"python ./evaluation/slr_eval/mergectmstm.py {prefix}tmp2.ctm {prefix}tmp.stm")
