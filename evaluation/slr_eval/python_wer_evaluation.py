...
if __name__ == '__main__':
    path = 'finetune_phoenix_results'
    path = 'work_dir_random_remove'
    #path = 'work_dir_sd'
    #path = 'work_dir_transfer_iso' # train on sd
    #path = 'work_dir_freeze_cnn'
    scores = []
    for i in range(100):
        print(i)

        res = wer_calculation('../../preprocess/gsl/gsl-groundtruth-dev.stm',
                        f'../../{path}/output-hypothesis-dev-{i}-conv.ctm')
        print(i, res)
